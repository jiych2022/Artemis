...
abstract class Printer
{
    ...
    public function renderOperand(Operand $var)
    {
    ...
    public function indent($str, $levels = 1)
    {
        if ($levels > 1) {
    ...
    /**
     * @return array{blocks: \SplObjectStorage, ops: \SplObjectStorage, varIds: \SplObjectStorage, blockIds: \SplObjectStorage}
     */
